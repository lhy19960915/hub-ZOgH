...
bert = BertModel.from_pretrained(r"D:\BaiduNetdiskDownload\week4 语言模型\bert-base-chinese", return_dict=False)
state_dict = bert.state_dict()
bert.eval()
x = np.array([2450, 15486, 102, 2110])   #假想成4个字的句子
torch_x = torch.LongTensor([x])          #pytorch形式输入
seqence_output, pooler_output = bert(torch_x)
print('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',seqence_output.shape, pooler_output.shape)
